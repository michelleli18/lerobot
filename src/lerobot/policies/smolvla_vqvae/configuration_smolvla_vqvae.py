"""Configuration for SmolVLA + VQ-VAE policy."""
...
@PreTrainedConfig.register_subclass("smolvla_vqvae")
@dataclass
class SmolVLAVQVAEConfig(PreTrainedConfig):
    ...
    action_dim: int = 23  # actual action dim for VQ-VAE

    # VQ-VAE tokenizer config
    vqvae_checkpoint_path: str = ""  # path to pretrained tokenizer
    vqvae_codebook_size: int = 512
    vqvae_latent_dim: int = 32
    vqvae_hidden_dim: int = 256
    vqvae_n_encoder_layers: int = 2
    vqvae_n_decoder_layers: int = 2
    vqvae_n_heads: int = 8
